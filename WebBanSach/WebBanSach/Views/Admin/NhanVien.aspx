...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <asp:GridView ID="dsNhanVien" runat="server" class="table" CellPadding="4" ForeColor="#333333" GridLines="Both" OnSelectedIndexChanged="dsNhanVien_SelectedIndexChanged1" AutoGenerateSelectButton="True">
